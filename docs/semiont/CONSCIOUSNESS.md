...
> 最後快照：2026-04-13（session γ heartbeat）
...
| --------------------------- | ------------------- |
| 👥 Contributors             | 55                  |
| 💓 Total Commits            | 1977（since birth） |
| 📝 知識細胞（中文 SSOT）    | 471 篇              |
| 🌐 英文細胞                 | 395 篇              |
| 🇪🇸 西文 / 🇯🇵 日文 / 🇰🇷 韓文 | 36 / 255 / 28 篇    |
| 📊 平均修訂次數             | 7.8 次/篇           |
...
### 🔍 搜尋感知（GA + Cloudflare，最新數據 4/13）

**GA 7日熱門文章（2026-04-06 to 04-13）**

| 排名 | 文章               | 7d views | 備註                         |
| ---- | ------------------ | -------- | ---------------------------- |
| 1    | **安溥**           | **521**  | 🔥 孢子效應爆發！升至 #1     |
| 2    | 鄭麗文             | 440      | 持續強勢（+17% vs 上次 375） |
| 3    | 台灣動物用藥爭議   | 35       |                              |
| 4    | 台灣宗教與寺廟文化 | 31       |                              |
| 5    | 八部合音           | 31       |                              |
| 6    | 台灣邦交國         | 29       |                              |
...
| Active Users    | 86,641   |
| Pageviews       | 218,634  |
| Avg Engagement  | 115.1 秒 |
| Engagement Rate | 42.05%   |
| Bounce Rate     | 57.95%   |

**SC 7日**：110 clicks / 1,414 impressions / CTR **7.78%**（品牌詞主導：taiwan.md 49c, taiwan md 31c）

**Cloudflare 7日（2026-04-06 to 04-13）— AI crawler 持續擴張**

| 指標            | 數值       | vs 上次  | 備註                      |
| --------------- | ---------- | -------- | ------------------------- |
| 總 requests     | **88,249** | +69.6%   | 7天窗口                   |
| Page Views      | **27,427** |          |                           |
| Uniques         | **19,458** |          |                           |
| AI crawler 偵測 | **23,686** | +48.3%   | 17 種 AI crawler 同時爬取 |
| AI HTTP 200     | **14,818** | +41.1%   | 成功抓取率 62.6%          |
| 404 rate        | **11.97%** | ↓ 13.68% | 改善中（EXP-A 方向正確）  |

**Top AI Crawlers（7天）**：Amazonbot 3,577、**FacebookBot 3,450（#2！+60%）**、PetalBot 3,360、PerplexityBot 3,089、BingBot 2,577、**ChatGPT-User 2,045（+81%）**、Googlebot 1,666、OAI-SearchBot 1,230

**戰略判讀（2026-04-13）**：

- **🔥 安溥孢子效應量化**：521 views/7d，升至 GA #1！孢子 3,762v + 142❤ + 17 則 perspectives = 完整社群迴路
- **鄭麗文持續強勢**：440v/7d（+17%），孢子效應長尾持續
- **韓國瑜 28v 初始**：β session 發孢子後開始爬，7d 後回頭驗證
- **404 rate 下降**：13.68% → 11.97%（EXP-2026-04-11-A 預測方向正確，目標 6%±2pp 需繼續觀察）
- **AI crawler 全面暴增**：23,686/7d（+48%），ChatGPT-User +81%，FacebookBot 升至 #2
- **SPORE-LOG 首次回填**：α session 回填 18 筆歷史數據，告別 0% 追蹤率 ✅
