...
## Step 2.7: 倫理/敏感素材閘（ETHICAL GATE）

> v2.1 新增（2026-04-18 δ-late session，觀察者：「以死亡作為貼文有可能消費死亡」）
> **觸發條件**：Step 2.5 blueprint 任一欄打上敏感度標記。

### 核心原則：主體的公開 framing > 媒體重構

當事人（或其家屬 / 樂團 / 同事）若已用公開行動處理這件事（公開感言 / 專輯獻詞 / 追悼會 / 受訪），**以該主體自己的 framing 為準**，不用媒體的記者重構版本。

### 倫理四問（逐條自檢）

1. **是否以死亡／創傷作為情感鉤？** 如果把這則敘事抽掉死亡，故事會消失嗎？→ 若「故事消失」=**死亡就是情感提款機**，需改 angle。
2. **細節是否必要？** 最後時刻重構（IG 原文 + 時差 + 地點細節）對敘事**推進**還是**獵奇**？→ 獵奇 = 刪。
3. **主體自己的公開行動是什麼？** 他們寫了專輯獻詞、說了追悼感言、做了公開姿態嗎？→ **優先採用這些，而非媒體重構**。
4. **活下來的人在做什麼？** 把鏡頭移到「他們用什麼方式繼續」而非「那個人怎麼沒了」→ agency over victimhood。

### 四問全過才進 Step 3。任一失敗 → 改 angle 或 blueprint bullet 重組。

### 具體 heuristics（可用素材 vs 避用素材）

| 類型            | ✅ 適用                                    | ❌ 避免                                |
| --------------- | ------------------------------------------ | -------------------------------------- |
| 死亡事件        | 當事者公開表達的紀念（專輯獻詞、追悼感言） | 最後時刻重構（IG 原文 + 時差 + 地點）  |
| 精神疾病 / 自殺 | 主體已公開談論的程度                       | 病歷、診斷、治療細節                   |
| 家庭悲劇        | 主體主動談及的                             | 親屬、未公開之家庭糾紛                 |
| 未成年經歷      | 本人成年後公開回憶的                       | 仍未成年者的隱私、身份、校名細節       |
| 族群 / 性別議題 | 當事者自己的定位                           | 代言、標籤化、簡化為 identity politics |

### Quote 判準：「如果本人或遺族讀到這段，會感受到尊重還是利用？」

這個判準不能量化，只能用同理心。若答案不是清楚的「尊重」→ 改。
